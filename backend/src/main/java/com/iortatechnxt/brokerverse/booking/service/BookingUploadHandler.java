 ...
 * optional booking date and cost center. Each valid row is booked in its own transaction, exactly
...
public class BookingUploadHandler implements BulkImportHandler {
  ...
  public BookingUploadHandler(
      BookingService booking, DimensionService dimensions, PlatformTransactionManager txManager) {
