 ...
 * NO_INVOICE; any unpaid invoice gives UNPAID; else any partly paid gives PARTIALLY_PAID; when every
 * invoice is a direct payment to the insurer the result is DIRECT_PAYMENT; otherwise PAID (return
 * invoices without a client receivable do not count against it).
 */
