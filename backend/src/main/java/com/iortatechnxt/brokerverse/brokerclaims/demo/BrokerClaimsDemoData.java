...
@Profile("demo")
@Order(130)
public class BrokerClaimsDemoData implements ApplicationRunner {

  private static final Logger LOG = LoggerFactory.getLogger(BrokerClaimsDemoData.class);
  ...
  /** Records the demo claims of every company; each step is skipped when it cannot run. */
  public void load() {
