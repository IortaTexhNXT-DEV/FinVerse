...
import com.iortatechnxt.brokerverse.budget.service.BudgetSpread;
...
/**
 * Approved FY2026 operating budget of the seed company: premium, investment and commission income
...
class SeedBudgetData {
  ...
  SeedBudgetData(BudgetService budgets, BudgetLineService lines, SeedUsers users) {
