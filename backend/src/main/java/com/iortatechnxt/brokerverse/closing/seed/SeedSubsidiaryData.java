...
/**
 * Seed journals of the subsidiary FVS (USD): share capital (80 % subscribed by FVI), monthly
 ...
 */
class SeedSubsidiaryData {

  private static final String SOURCE = "PLANNING_SEED";
