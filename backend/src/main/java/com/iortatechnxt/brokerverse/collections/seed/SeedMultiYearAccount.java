...
/**
 * The three-year seed account of the Collections billing storyline (BRCLXN.058, seed profile only):
 * a PAR01 property policy of 2026-09-01 to 2029-09-01 for seed client CL-2026-000005, brought to
...
@Component
@Profile("seed")
public class SeedMultiYearAccount {
            ...
            documents.upload(
                ...
                List.of(
                    new UploadedFile(
                        ...
                        "%PDF-1.4 seed".getBytes(StandardCharsets.US_ASCII))),
  ...
  private static RiskItemData location() {
    return new RiskItemData(
        ...
        null,
        new Location(
            "41 Installment Street, Kapitolyo",
            "Pasig",
            "Metro Manila",
            "DWELLING",
            "CLASS_1",
