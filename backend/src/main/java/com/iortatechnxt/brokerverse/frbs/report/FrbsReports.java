    ...
    return new FrbsSqlReport(
        new Spec(
            ...
            "select g.bucket, g.assets, g.liabilities, g.assets - g.liabilities gap,"
                ...
                + " when o.due_date <= :to + 30 then '1. 1 - 30 days'"
                + " when o.due_date <= :to + 90 then '2. 31 - 90 days'"
                + " when o.due_date <= :to + 180 then '3. 91 - 180 days'"
                + " when o.due_date <= :to + 365 then '4. 181 - 365 days'"
