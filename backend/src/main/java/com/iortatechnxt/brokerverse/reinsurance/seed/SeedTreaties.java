...
import com.iortatechnxt.brokerverse.reinsurance.api.dto.TreatyRequest.LayerRequest;
import com.iortatechnxt.brokerverse.reinsurance.api.dto.TreatyRequest.ParticipantRequest;
...
/**
 * Static definition of the seed reinsurance programme for underwriting year 2026: fire quota share
...
final class SeedTreaties {
  ...
  private SeedTreaties() {}

  /**
   * Treaty requests of the seed programme.
   *
  ...
  /** Identification of a seed treaty. */
  private record Terms(String code, String name, TreatyType type, String lob) {}

  /** Capacity terms of a proportional seed treaty. */
