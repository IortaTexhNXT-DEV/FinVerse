...
/**
 * Reserve parameters of the seed lines of business: a mix of the rate and chain-ladder IBNR
...
final class SeedReserveParameters {
  ...
  /** Parameters by line of business code (the codes of the underwriting seed products). */
