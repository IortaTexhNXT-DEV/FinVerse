...
/** Rows of {@link TemplateRow}. */
public interface TemplateRowRepository extends JpaRepository<TemplateRow, Long> {
   ...
   * @return rows
   */
  List<TemplateRow> findByVersionIdOrderByIdAsc(Long versionId);
   ...
   * @return rows
   */
  List<TemplateRow> findByVersionIdIn(Collection<Long> ids);
  ...
  @Query("delete from TemplateRow r where r.versionId = :versionId")
