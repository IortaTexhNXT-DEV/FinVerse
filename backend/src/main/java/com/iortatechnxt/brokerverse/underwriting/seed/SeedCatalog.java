...
/**
 * Static reference values of the underwriting seed data: products with Philippine tax settings,
 * risk profiles per line of business, clients and locations. Values are deterministic so every seed
 * start produces the same portfolio.
 */
final class SeedCatalog {

  /** Seed clients (policyholders) created by the seed migrations. */
  ...
  /**
   * Risk profile of a seed product.
   *
