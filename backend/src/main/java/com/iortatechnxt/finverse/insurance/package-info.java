 ...
 *
 * <ul>
 *   <li>claims implements {@link com.iortatechnxt.finverse.insurance.ClaimsExperienceView} and
 *       notifies every {@link com.iortatechnxt.finverse.insurance.ClaimMovementListener} bean;
 *   <li>reinsurance implements {@link com.iortatechnxt.finverse.insurance.ClaimMovementListener}
 *       (to book recoveries and reserve shares) and {@link
 *       com.iortatechnxt.finverse.insurance.ClaimReinsuranceView};
