...
/**
 * PDF export in the corporate report layout: company, title, generated by/at, parameter echo,
 * repeated column headings, group headers, subtotals, grand total, "*** End of Report ***" and a
 * page footer with the administrator's footer text ({@code REPORT_FOOTER_TEXT}) and "Page n of m".
 */
...
public class PdfReportRenderer implements ReportRenderer {
  ...
  private static final Color BRAND_NAVY = new Color(0x00, 0x20, 0x5B);
  private static final Color BRAND_BLUE = new Color(0x00, 0x33, 0xA0);
  private static final Color BRAND_GOLD = new Color(0xFD, 0xB9, 0x13);
  private static final Color GROUP_BG = new Color(0xE8, 0xEE, 0xF8);
  ...
  private static void addHeader(Document doc, ReportResult result, ReportContext ctx) {
    ...
    for (String line : result.parameterEcho()) {
      doc.add(new Paragraph(line, META));
    }
   ...
   * and "iNXT FinVerse | report code | Page n of m" (right) at the foot of every page.
   */
  private static final class PageFooter extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
      ...
      String text = "iNXT FinVerse  |  " + code + "  |  Page " + writer.getPageNumber() + " of ";
