 ...
 * repeated column headings, group headers, subtotals, grand total, "Page n of m" and "*** End of
 * Report ***".
 */
...
public class PdfReportRenderer implements ReportRenderer {
  ...
  public byte[] render(ReportResult result, ReportContext context) {
    ...
    try (Document doc = new Document(size, MARGIN, MARGIN, MARGIN, MARGIN + 10)) {
      ...
      writer.setPageEvent(new PageFooter(result.code(), writer));
  ...
  /** Writes "Report code – Page n of m" at the foot of every page. */
  private static final class PageFooter extends PdfPageEventHelper {
    ...
    PageFooter(String code, PdfWriter writer) {
      this.code = code;
