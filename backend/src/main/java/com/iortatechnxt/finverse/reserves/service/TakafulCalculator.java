 ...
 * FinVerse rule documented on {@link TakafulItem}. Amounts are the company share in base currency
 * of the transactions of the expiring policy period; claims are the incurred claims reported by the
 * claims module (zero without it), retakaful the treaty + FAC premium ceded (zero without the
 * reinsurance module).
 */
@Component
