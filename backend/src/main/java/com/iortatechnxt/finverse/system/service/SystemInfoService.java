...
public class SystemInfoService {
  ...
  public static final String PRODUCT = "iNXT FinVerse";
  ...
  private static final List<String> VISIBLE_KEYS =
      List.of(
          ...
          "finverse.security.token-validity",
          "finverse.security.allowed-origins",
          "finverse.attachments.max-size",
          "finverse.jobs.recurring-journals-cron",
          "finverse.jobs.alert-checks-cron",
