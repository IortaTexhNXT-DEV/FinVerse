 ...
 *
 * <p>{@code trackFiling = false} marks reminder-only forms prepared outside FinVerse (e.g. 1601-C
 * from payroll): they are listed on the calendar but raise no alerts and have no returns. The
 * calendar starts at {@code effectiveFrom}, so go-live does not produce alerts for older periods.
 */
@Entity
@Table(name = "tax_form")
