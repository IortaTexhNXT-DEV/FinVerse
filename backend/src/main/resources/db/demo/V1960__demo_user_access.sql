-- =====================================================================================
-- iNXT BrokerVerse - V1960 Demo data of User Access Maintenance (BRD-11, wave U1-A).
-- DEMO ONLY - never load in production. Password of the demo users: Brokerverse@2026.
...
--   Working hours:        the demo and the automated tests run around the clock, so
...
from (values ('requestor',   'Rhea Access Requestor',   'requestor@brokerverse-demo.ph'),
             ('uamapprover', 'Ulysses Access Approver', 'uamapprover@brokerverse-demo.ph'),
             ('secapprover', 'Selina Second Approver',  'secapprover@brokerverse-demo.ph'),
             ('a013000101',  'Demo Enrolled User',      'a013000101@brokerverse-demo.ph'),
             ('a013000102',  'Demo Leaver',             'a013000102@brokerverse-demo.ph'),
             ('a013000103',  'Demo Transferee',         'a013000103@brokerverse-demo.ph'),
             ('a013000104',  'Demo Team Lead',          'a013000104@brokerverse-demo.ph'))
...
values ('BLK-DEMO-000001', 'uam-bulk-demo.xlsx', 3, 'PENDING', 'Three new Marketing account officers',
...
values
    ...
    ('AR-DEMO-000001', 'CREATE_USER', 'INTERNAL', 'a013000190', 'Demo Draft User', null, 'MKT_AO',
    ...
    ('AR-DEMO-000002', 'MODIFY_USER', 'INTERNAL', 'a013000101', null, null, 'MKT_AO,TSU',
    ...
    ('AR-DEMO-000003', 'DISABLE_USER', 'INTERNAL', 'a013000102', null, null, null,
    ...
    -- Cancelled
    ('AR-DEMO-000004', 'CREATE_USER', 'INTERNAL', 'a013000191', 'Demo Cancelled Hire', null, 'MKT_AO',
    ...
    ('AR-DEMO-000005', 'DISABLE_USER', 'INTERNAL', 'a013000103', null, null, null,
    ...
    ('AR-DEMO-000006', 'CREATE_USER', 'INTERNAL', 'a013000101', 'Demo Enrolled User',
     'a013000101@brokerverse-demo.ph', 'MKT_AO', 'Joined Marketing', 'APPROVED', null, null, null,
    ...
    ('AR-DEMO-000007', 'CREATE_ROLE', 'INTERNAL', null, null, null, null,
    ...
    -- Privileged change waiting for the second approval
    ('AR-DEMO-000008', 'MODIFY_USER', 'INTERNAL', 'a013000104', null, null, 'MKT_AO,SYSADMIN',
...
select 'AR-DEMO-00001' || n, 'CREATE_USER', 'INTERNAL', 'a01300021' || n, 'Demo Bulk Officer ' || n,
       'MKT_AO', 'Joined Marketing', 'PENDING', 'uamapprover',
       (select id from nba_access_request_batch where batch_no = 'BLK-DEMO-000001'),
...
where r.request_no like 'AR-DEMO-%' and r.status not in ('DRAFT', 'CANCELLED');
...
from nba_access_request r where r.request_no like 'AR-DEMO-%';

insert into nba_access_request_event (request_id, action, from_status, to_status, remarks, actor, occurred_at)
select r.id, 'SUBMIT', 'DRAFT', 'PENDING', r.justification, r.submitted_by, r.submitted_at
from nba_access_request r where r.request_no like 'AR-DEMO-%' and r.submitted_at is not null;
...
from nba_access_request r
where r.request_no like 'AR-DEMO-%' and r.decided_at is not null;

insert into nba_access_request_event (request_id, action, from_status, to_status, remarks, actor, occurred_at)
select r.id, 'CANCEL', 'PENDING', 'CANCELLED', r.cancel_reason, r.cancelled_by, r.cancelled_at
from nba_access_request r where r.request_no = 'AR-DEMO-000004';

insert into nba_access_request_event (request_id, action, from_status, to_status, remarks, actor, occurred_at)
select r.id, 'APPLY', 'APPROVED', 'APPROVED', null, r.decided_by, r.applied_at
from nba_access_request r where r.request_no = 'AR-DEMO-000006';
...
select now() - interval '9 day', 'USER', 'a013000101', 'CREATE_USER', a.attribute, null, a.value,
       'AR-DEMO-000006', 'uamapprover', 'uamapprover'
from (values ('fullName', 'Demo Enrolled User'), ('email', 'a013000101@brokerverse-demo.ph'),
