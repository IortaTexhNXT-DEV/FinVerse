-- =====================================================================================
-- DEMO DATA (demo profile only): business partners and accounting rules for the demo
...
from org_company c, (values
  ...
  ('R-0001','National Reinsurance Corp. (Demo)','REINSURER','601-111-222-000','Makati City','ri@natre.example','+63 2 888 0001','PHP',90,null,null,null),
  ('R-0002','Asia Pacific Re (Demo)','REINSURER',null,'Singapore','ri@apre.example','+65 6000 0002','USD',90,null,null,null),
  ('R-0003','Global Specialty Re (Demo)','REINSURER',null,'London','ri@gsre.example','+44 20 0000 0003','USD',90,null,null,null),
  ('CO-0001','Philippine Mutual Assurance (Demo)','COINSURER','701-111-222-000','Manila','coins@pma.example','+63 2 666 0001','PHP',60,null,null,null),
  ...
  ('S-0003','Ayala Property Leasing (Demo)','SUPPLIER','803-111-222-000','Makati City','leasing@apl.example','+63 2 444 0003','PHP',30,null,5.0,null),
