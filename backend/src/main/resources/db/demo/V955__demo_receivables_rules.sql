-- =====================================================================================
-- DEMO DATA (demo profile only): accounting rule for applying unapplied collections.
...
-- Receipts, deposits, PDCs and bank statements are created by ReceivablesDemoData.
-- =====================================================================================
