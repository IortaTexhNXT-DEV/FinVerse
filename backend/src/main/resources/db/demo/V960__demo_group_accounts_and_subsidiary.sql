-- =====================================================================================
-- DEMO DATA (demo profile only): group accounts of the parent and a foreign subsidiary so
-- inter-company postings, FX revaluation and consolidation can be demonstrated.
