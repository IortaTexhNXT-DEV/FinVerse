-- =====================================================================================
-- DEMO DATA (demo profile only): accounting rule of the TAX_REMITTANCE event for the demo
...
-- certificates are created by the TaxDemoData runner through the services (maker-checker).
-- Every lookup is scoped to company FVI (a second demo company FVS exists).
-- =====================================================================================
