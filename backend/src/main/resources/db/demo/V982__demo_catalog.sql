-- =====================================================================================
-- iNXT BrokerVerse - V982 Demo catalog data (demo profile only): a fictional insurer panel
-- (names invented for the demo, no real insurers), branches with their LGT rates,
-- commission rates, NB cost centers and the sales organisation of the demo account officers.
-- =====================================================================================
...
-- Cost centers of the New Business sales teams (BRNB.108) and the demo sales organisation.
