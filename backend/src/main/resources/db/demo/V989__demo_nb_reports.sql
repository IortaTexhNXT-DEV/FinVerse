-- =====================================================================================
-- iNXT BrokerVerse - V989 Demo New Business reports (demo profile only).
--   * The demo company becomes a broker: "BDOI Demo Insurance Brokers, Inc." (code FVI kept,
--     so every demo reference stays valid), and its Singapore subsidiary likewise.
...
update org_company set name = 'BDOI Demo Insurance Brokers, Inc.' where code = 'FVI';
update org_company set name = 'BDOI Demo Insurance Brokers (Singapore) Pte. Ltd.' where code = 'FVS';
