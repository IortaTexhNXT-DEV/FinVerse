-- =====================================================================================
-- iNXT BrokerVerse - V995 Demo commission receivables (demo profile only). DEMO ONLY.
--   * Demo accounting rules of the commission events (OPERATIONS_DESIGN section 5 rows 22-26);
...
--   The direct payment storyline (DP list, validation, billing) runs on the demo direct payment
--   booking ARN-2026-940003 through commission.demo.CommissionDemoData.
-- =====================================================================================
...
from org_company c
cross join (values
    ('OPS_DP_COMMISSION_COLLECT', 'Direct payment commission collected (demo)'),
    ('OPS_DP_PR_REVERSAL', 'Direct payment PR reversal (demo)'),
    ('OPS_DP_REINSTATE', 'Direct payment reinstatement (demo)'),
    ('OPS_INCENTIVE_ACCRUE', 'Incentive earned from insurer (demo)'),
    ('OPS_INCENTIVE_PASS_ON', 'Incentive pass-on to branches (demo)')
