-- =====================================================================================
-- iNXT BrokerVerse - V996 Demo Product Maintenance catalog data (demo profile only).
-- DEMO ONLY - never load in production.
...
--   PMADD07/08  incentive criterion "CPC2 (demo)" on Motor and Property packages, ACTIVE, and the
--            booking incentive rule of the demo (V988) copied into the catalog as V871 does for
...
values ('MTR12', 2, 'DRAFT', current_date + 30, current_date + 30, current_date + 395, null, 1.25,
        ...
        'Demo: yearly review of the MTR12 package with a panel of two insurers', now(), 'mbs');
...
-- ---------- Incentive criterion CPC2 (demo), ACTIVE ----------------------------------------
insert into lov_value (type_code, code, label, sort_order, parent_code, effective_from, record_status,
                       authorized_by, authorized_at, created_at, created_by)
select 'INCENTIVE_TYPE', 'CAMPAIGN', 'Sales campaign (demo)', 10, null, date '2020-01-01', 'ACTIVE',
...
select id, 'CPC2', 'CPC2 (demo)', 'CAMPAIGN', 'RATE', 1.00, '{"minimumPremium": 5000}',
       'Demo criterion: CBG motor and property packages sold in 2026 (definition pending, PQ04)',
...
-- ---------- Demo booking incentive rules copied like V871 (pending authorisation) -----------
insert into cat_incentive_criteria (company_id, code, name, incentive_type, value_basis, value,
