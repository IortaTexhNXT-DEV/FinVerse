-- =====================================================================================
-- iNXT BrokerVerse - V998 Demo Product Maintenance (BRD-3) users (demo profile only; password
-- for all users: Brokerverse@2026). DEMO ONLY - never load in production.
...
--   second maker can be demonstrated. V996 / V997 hold the catalog and package request demo data.
-- =====================================================================================
...
from (values ('tsuhead', 'Tomas TSU Head',            'tsuhead@brokerverse-demo.ph'),
             ('mbs',     'Monica Business Services',  'mbs@brokerverse-demo.ph'),
             ('mbs2',    'Marco Business Services',   'mbs2@brokerverse-demo.ph'),
             ('mancom',  'Manuel ManCom Member',      'mancom@brokerverse-demo.ph'))
