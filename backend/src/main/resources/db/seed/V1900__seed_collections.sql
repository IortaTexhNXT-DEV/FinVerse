...
--   * Unit Heads of the seed sales organisation (BRCLXN.011/012, CQ05; V819).
...
--   The collection items themselves are not seeded: the seed invoices reach the ledger at
--   start-up (booking and Operations seed runners), and collections.seed.CollectionsSeedData
--   refreshes the worklist from them and records the dispositions, efforts, hand-offs,
--   reassignment and files of the storyline as the SIT/UAT users.
-- =====================================================================================
...
from (values ('clxhandler', 'Clara Collection Handler', 'clxhandler@brokerverse-seed.ph'),
             ('clxtl',      'Carlo Collection Lead',    'clxtl@brokerverse-seed.ph'),
             ('clxuh',      'Ursula Section Head',      'clxuh@brokerverse-seed.ph'),
             ('mkthandler', 'Marco Marketing Handler',  'mkthandler@brokerverse-seed.ph'))
