-- =====================================================================================
-- iNXT BrokerVerse - V1901 Seed Collections plans and escalation (wave C1-B, seed data).
--   Requirements: docs/requirements/BDOI_CLXN_BRD_SPEC.md BRCLXN.049/053/055/058
--   Design: docs/architecture/COLLECTIONS_DESIGN.md sections 3 (seed V1901) and 4.3.
...
--   after the Operations seed as the Java runner collections.seed.CollectionsPlansSeedData.
-- =====================================================================================
