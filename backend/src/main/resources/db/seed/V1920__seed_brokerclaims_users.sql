...
--   The seed Marketing users (ao, ao2 = MKT_AO; mkttl = MKT_TL) receive the Claims report
--   permissions through their roles (V1020). The roles and grants are in V1020; the insurer seed
--   user "claims" is unrelated and keeps its insurer roles. Insurer location references come with
--   V1921 (CL1-A); seed claims with brokerclaims.seed.BrokerClaimsSeedData (CL1-A / CL1-B).
-- =====================================================================================
...
select u.username, u.full_name, u.email,
       ...
       now(), 'SYSTEM'
from (values ('clmofficer',  'Clarissa Claims Officer',        'clmofficer@brokerverse-seed.ph',  'HO'),
             ('clmofficer2', 'Cedric Claims Officer',          'clmofficer2@brokerverse-seed.ph', 'HO'),
             ('clmbranch',   'Consuelo Claims Officer (Cebu)', 'clmbranch@brokerverse-seed.ph',   'CEB'),
             ('clmtl',       'Teodoro Claims Team Lead',       'clmtl@brokerverse-seed.ph',       'HO'),
             ('clmth',       'Theresa Claims Team Head',       'clmth@brokerverse-seed.ph',       'HO'),
             ('clmuh',       'Ulysses Claims Unit Head',       'clmuh@brokerverse-seed.ph',       'HO'),
             ('clmrisk',     'Rosario Claims Risk Analyst',    'clmrisk@brokerverse-seed.ph',     'HO'))
