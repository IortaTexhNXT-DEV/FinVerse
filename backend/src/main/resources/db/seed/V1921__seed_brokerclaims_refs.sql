-- =====================================================================================
-- iNXT BrokerVerse - V1921 Seed Claims Handling (BRD-7), wave CL1-A: insurer location references
-- of the seed property covers (seed profile only).
--   BRCLM.042 insurer location references per location of a cover and insurer, with effective
--   dates: the booking seed property covers (V988) get the reference their insurer uses; one of
--   them has a superseded reference so the history shows on Cover Lookup. The seed claims are
--   recorded at start-up by brokerclaims.seed.BrokerClaimsSeedData through the services.
