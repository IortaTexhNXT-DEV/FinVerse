-- =====================================================================================
-- iNXT BrokerVerse - V1951 Seed Sanction Screening (BRD-10) watchlist entries and screening run
-- (wave S1-B). SEED DATA ONLY - never load in production.
...
--   SNSRP-301  one completed batch screening run (PERIODIC) of the seed company FVI with a potential
--              match of the seed client CL-2026-000002 (already rated HIGH with the WATCHLIST_REVIEW
--              tag by V981, so the rules change nothing and no risk-profile row is written).
--   The entries are chosen so that no other seed client (V981, V983) matches them under the seed
...
select s.id, e.ref, s.list_type, e.etype, e.name, null, null, e.birth::date, e.nat, e.ids,
       ...
       'Seed entry - invented name', now(), 'compoff'
from (values
    -- AML advisory (sanctions)
    ('AML_ADVISORY', 'AML-900001', 'INDIVIDUAL', 'Juan de la Cruz', '1970-02-15', 'FILIPINO', null, '2025-03-01', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900002', 'INDIVIDUAL', 'Jose Miguel Lopez Reyes', '1979-11-02', 'FILIPINO', null, '2025-06-15', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900003', 'INDIVIDUAL', 'Zoltan Brakovic Invented', '1962-06-01', null, 'XP-0000301', '2024-11-20', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900004', 'ENTITY', 'Kestrel Maritime Fictional Ltd.', null, null, null, '2024-08-05', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900005', 'INDIVIDUAL', 'Orvald Nightingale Quist', '1958-01-09', null, null, '2023-05-30', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900006', 'INDIVIDUAL', 'Tamsin Vey Larkwood', '1981-12-12', null, null, '2025-01-10', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900007', 'ENTITY', 'Blackfen Trading Fictitious Corp.', null, null, null, '2024-02-14', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900008', 'INDIVIDUAL', 'Ignatius Ferro Mandalay', '1966-04-04', null, null, '2025-07-07', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900009', 'INDIVIDUAL', 'Casimir Delacroix Imaginario', '1975-10-31', null, null, '2025-09-01', null, 'ACTIVE'),
    ('AML_ADVISORY', 'AML-900010', 'ENTITY', 'Northwind Phantom Holdings', null, null, null, '2023-12-01', null, 'ACTIVE'),
    -- NLDS politically exposed persons
    ('NLDS_PEP', 'PEP-900001', 'INDIVIDUAL', 'Marietta Sandoval Reyna', '1968-08-18', 'FILIPINO', null, '2025-02-01', null, 'ACTIVE'),
    ('NLDS_PEP', 'PEP-900002', 'INDIVIDUAL', 'Honorato Buenaventura Lacsamana', '1955-03-25', 'FILIPINO', null, '2024-06-30', null, 'ACTIVE'),
    ('NLDS_PEP', 'PEP-900003', 'INDIVIDUAL', 'Leonora Quimbo Invencion', '1972-09-09', 'FILIPINO', null, '2025-04-15', null, 'ACTIVE'),
    ('NLDS_PEP', 'PEP-900004', 'INDIVIDUAL', 'Faustino Dimaculangan Ficticio', '1960-11-11', 'FILIPINO', null, '2024-10-01', null, 'ACTIVE'),
    ('NLDS_PEP', 'PEP-900005', 'INDIVIDUAL', 'Rosalinda Macaraeg Imbento', '1977-05-05', 'FILIPINO', null, '2025-05-20', null, 'ACTIVE'),
    ('NLDS_PEP', 'PEP-900006', 'INDIVIDUAL', 'Teodoro Villafuerte Kathangisip', '1949-07-04', 'FILIPINO', null, '2023-09-09', null, 'ACTIVE'),
    ('NLDS_PEP', 'PEP-900007', 'INDIVIDUAL', 'Esperanza Magbanua Likha', '1983-02-28', 'FILIPINO', null, '2025-08-08', null, 'ACTIVE'),
    ('NLDS_PEP', 'PEP-900008', 'INDIVIDUAL', 'Crisanto Padilla Gawain', '1964-12-01', 'FILIPINO', null, '2024-12-12', null, 'ACTIVE'),
    -- Internal watchlist
    ('INTERNAL', 'INT-900001', 'INDIVIDUAL', 'Gideon Farrow Pellucid', '1987-03-03', null, null, '2025-03-03', null, 'ACTIVE'),
    ('INTERNAL', 'INT-900002', 'INDIVIDUAL', 'Ysolde Marchetti Vane', '1990-10-10', null, null, '2025-06-06', null, 'ACTIVE'),
    ('INTERNAL', 'INT-900003', 'ENTITY', 'Hollowmere Assurance Brokers Fictional Inc.', null, null, null, '2024-04-04', null, 'ACTIVE'),
    ('INTERNAL', 'INT-900004', 'INDIVIDUAL', 'Percival Thorne Umbry', '1971-01-21', null, null, '2025-01-21', null, 'ACTIVE'),
    ('INTERNAL', 'INT-900005', 'INDIVIDUAL', 'Ondine Castellar Wray', '1985-06-16', null, null, '2025-02-16', null, 'ACTIVE'),
    ('INTERNAL', 'INT-900006', 'INDIVIDUAL', 'Rufus Dellamorte Fict', '1959-09-19', null, null, '2023-01-19', '2025-01-19', 'INACTIVE'),
    ('INTERNAL', 'INT-900007', 'INDIVIDUAL', 'Aurelio Montclair Nox', '1978-08-28', null, null, '2025-08-28', null, 'ACTIVE')
...
from (values ('AML-900001', 'Juanito Dela Cruz'),
             ('AML-900003', 'Zoli Brakovic'),
             ('AML-900004', 'Kestrel Shipping Fictional'),
             ('PEP-900002', 'Honorato B. Lacsamana'),
             ('INT-900002', 'Ysolde Vane')) as a(ref, alias)
...
cross join (values
    (2, 'AML-900091,INDIVIDUAL,,,,,,,,,,', 'Primary Name is required'),
    (3, 'AML-900092,INDIVIDUAL,Invented Person Two,,,,31-02-1970,,,,,', 'Birth Date 31-02-1970 is not a valid date'),
    (4, 'AML-900093,COMPANY,Invented Company Three,,,,,,,,,', 'Entity Type COMPANY is not INDIVIDUAL or ENTITY')
...
join scr_watchlist_entry e on e.external_ref = 'AML-900002'
