-- =====================================================================================
-- SEED DATA (seed profile only): reinsurance.
-- Two additional Asian reinsurers and a reinsurance broker for the seed company, and the
-- accounting rules of the reinsurance statement events. Treaties, cessions, facultative
-- placements and statements of account are created at start-up by ReinsuranceSeedData
-- through the services, so journals and open items are real.
-- Every lookup is scoped to the seed company FVI (the subsidiary FVS has no reinsurance).
-- =====================================================================================
...
from org_company c, (values
  ('R-0004', 'Pan Asian Reinsurance (Seed)', 'REINSURER', null, 'Hong Kong',
   'treaty@panasianre.example', '+852 3000 0004', 'PHP', 90, null),
  ('R-0005', 'Asia Capital Reinsurance (Seed)', 'REINSURER', null, 'Singapore',
   'treaty@asiacapre.example', '+65 6000 0005', 'PHP', 90, null),
  ('RB-0001', 'Manila Reinsurance Brokers (Seed)', 'RI_BROKER', '602-111-222-000', 'Makati City',
