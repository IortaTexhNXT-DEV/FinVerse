-- =====================================================================================
-- SEED DATA (seed profile only): fixed asset categories, investment portfolios, issuer /
-- depository parties and the accounting rules of the fixed asset and investment events
-- for the seed chart of accounts. Assets, holdings and their postings are created by the
-- seed data runners (FixedAssetSeedData, InvestmentSeedData) through the services.
-- =====================================================================================
...
from org_company c, (values
  ('IS-BTR', 'Bureau of the Treasury (Seed)', 'BANK', '000-000-001-000', 'Intramuros, Manila', 'ross@treasury.example', '+63 2 5000 0001'),
  ('BK-BDO', 'BDO Unibank Inc. (Seed)', 'BANK', '000-000-002-000', 'Makati City', 'treasury@bdo.example', '+63 2 5000 0002'),
  ('BK-BPI', 'Bank of the Philippine Islands (Seed)', 'BANK', '000-000-003-000', 'Makati City', 'treasury@bpi.example', '+63 2 5000 0003'),
  ('BK-LBP', 'Land Bank of the Philippines (Seed)', 'BANK', '000-000-004-000', 'Manila', 'treasury@lbp.example', '+63 2 5000 0004'),
  ('IS-ALI', 'Ayala Land Inc. (Seed issuer)', 'CORPORATE_CLIENT', '000-000-005-000', 'Makati City', 'ir@ali.example', '+63 2 5000 0005'),
  ('IS-SMIC', 'SM Investments Corporation (Seed issuer)', 'CORPORATE_CLIENT', '000-000-006-000', 'Pasay City', 'ir@smic.example', '+63 2 5000 0006')
