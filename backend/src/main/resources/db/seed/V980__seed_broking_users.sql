...
from (values ('ao',       'Aileen Account Officer',   'ao@brokerverse-seed.ph',       null::numeric),
             ('ao2',      'Arnel Account Officer',    'ao2@brokerverse-seed.ph',      null),
             ('mkttl',    'Marites Marketing Lead',   'mkttl@brokerverse-seed.ph',    null),
             ('tsu',      'Teodoro TSU Analyst',      'tsu@brokerverse-seed.ph',      null),
             ('tsulead',  'Teresa TSU Lead',          'tsulead@brokerverse-seed.ph',  null),
             ('proc',     'Paolo Processor',          'proc@brokerverse-seed.ph',     null),
             ('proctl',   'Patricia Processing Lead', 'proctl@brokerverse-seed.ph',   null),
             ('approver', 'Andres Approver',          'approver@brokerverse-seed.ph', 5000000),
             ('epol',     'Elena E-policy Sender',    'epol@brokerverse-seed.ph',     null),
             ('adjust',   'Adrian Adjustment',        'adjust@brokerverse-seed.ph',   null),
             ('badmin',   'Bea Business Admin',       'badmin@brokerverse-seed.ph',   null))
