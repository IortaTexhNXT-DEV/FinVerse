...
class CollectionsPlansIT {
  ...
  void aThreeYearAccountGetsAStatementOfAccountPerBillingCycle() {
    ...
    assertThat(plan.getInstallments())
        ...
        .containsExactly(
            CollectionsPlanFixtures.MULTI_YEAR_FROM,
            CollectionsPlanFixtures.MULTI_YEAR_FROM.plusYears(1),
            CollectionsPlanFixtures.MULTI_YEAR_FROM.plusYears(2));
    assertThat(plan.getInstallments())
    ...
    assertThat(soas)
        ...
        .containsExactly(
            CollectionsPlanFixtures.MULTI_YEAR_FROM.plusYears(1).minusDays(1),
            CollectionsPlanFixtures.MULTI_YEAR_FROM.plusYears(2).minusDays(1),
            CollectionsPlanFixtures.MULTI_YEAR_FROM.plusYears(3).minusDays(1));
                ...
                as.run(
                    ...
                    () ->
                        plans.fromPolicyYears(
                            company,
                            "ARN-NONE-" + CollectionsPlanFixtures.token(),
                            "ANNUAL",
                            null)))
        .extracting("code")
