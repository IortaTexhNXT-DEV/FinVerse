...
import com.iortatechnxt.brokerverse.fixedasset.domain.AssetMovement;
...
import com.iortatechnxt.brokerverse.fixedasset.domain.MovementType;
...
import com.iortatechnxt.brokerverse.fixedasset.service.DepreciationService.Proposal;
import com.iortatechnxt.brokerverse.fixedasset.service.DisposalPreview;
...
/** Fixed asset life cycle against the seed chart; every test rolls back. */
@IntegrationTest
@Transactional
class FixedAssetIT {
