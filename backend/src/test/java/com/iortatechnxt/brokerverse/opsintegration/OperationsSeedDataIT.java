...
import com.iortatechnxt.brokerverse.adjustment.seed.AdjustmentSeedData;
import com.iortatechnxt.brokerverse.cashiering.seed.CashieringSeedData;
import com.iortatechnxt.brokerverse.commission.seed.CommissionSeedData;
import com.iortatechnxt.brokerverse.opsledger.seed.OpsLedgerSeedReplay;
...
import com.iortatechnxt.brokerverse.prodrecon.seed.ProdReconSeedData;
import com.iortatechnxt.brokerverse.remittance.seed.RemittanceSeedData;
...
/**
 * Loads the seed profile in its own database and checks the Operations storyline: every Operations
 * screen has real data after start-up, each record was made by the SIT/UAT user who would do the
 * work, and the runners change nothing when the application starts again.
 */
@SpringBootTest
@AutoConfigureMockMvc
@ActiveProfiles({"test", "seed"})
@AutoConfigureEmbeddedDatabase(provider = DatabaseProvider.ZONKY)
class OperationsSeedDataIT {
  ...
  @Autowired private OpsLedgerSeedReplay replay;
  @Autowired private CashieringSeedData cashiering;
  @Autowired private RemittanceSeedData remittance;
  @Autowired private AdjustmentSeedData adjustment;
  @Autowired private ProdReconSeedData prodrecon;
  @Autowired private CommissionSeedData commission;
  ...
  @Test
  void eachStepWasDoneByTheSeedUserWhoseJobItIs() {
