...
| `V1062__nbadmin_request_lifecycle.sql` | U1-A | `nba_access_request`: new columns (section 4.2); check constraints widened to the new statuses and types. `nba_access_request_event`, `nba_access_request_approver`, `nba_access_request_batch` |
...
| New / Edit Request | `/user-access/requests/new`, `/user-access/requests/:id/edit` | type permission | One form for the four user types: user search, user data, group profiles, effective date, approver, remarks; Save Draft / Submit / Cancel (1.002-1.007) |
