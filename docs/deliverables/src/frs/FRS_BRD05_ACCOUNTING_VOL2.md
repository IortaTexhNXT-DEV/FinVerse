...
| R7 | BRD-5 FRS Volume 1 (FRBS and Accounting) | v1.0 | `docs/deliverables/out/FRS/BIBS_FRS_BRD-05_Accounting_Disbursement_ACSL_Vol1_v1.0.docx` |
| R8 | BRD-2 Operations FRS (remittance, cashiering, commission) | v1.0 | `docs/deliverables/out/FRS/BIBS_FRS_BRD-02_Operations_v1.0.docx` |
| R9 | BRD-4 Collections FRS (collector requests to Cashiering) | v1.0 | `docs/deliverables/out/FRS/BIBS_FRS_BRD-04_Collections_v1.0.docx` |
