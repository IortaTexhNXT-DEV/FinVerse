...
| OQ07 | Operations | GL accounts and entries | **Partially (draft 061/063).** Incentives are Other Income; commission refunds are classified apart from CR | Demo rules only (design section 5) |
